...
mixin _$Spots {
  ...
  /// Serializes this Spots to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of Spots
...
class _$SpotsImpl implements _Spots {
  ...
  @override
  String toString() {
    return 'Spots(addr1: $addr1, addr2: $addr2, areacode: $areacode, booktour: $booktour, cat1: $cat1, cat2: $cat2, cat3: $cat3, contentid: $contentid, contenttypeid: $contenttypeid, cpyrht: $cpyrht, createdtime: $createdtime, dist: $dist, firstimage: $firstimage, firstimage2: $firstimage2, mapx: $mapx, mapy: $mapy, mlevel: $mlevel, modifiedtime: $modifiedtime, sigungucode: $sigungucode, tel: $tel, title: $title)';
  }
...
abstract class _Spots implements Spots {
  factory _Spots(
      ...
      final String sigungucode,
      final String tel,
      final String title}) = _$SpotsImpl;
