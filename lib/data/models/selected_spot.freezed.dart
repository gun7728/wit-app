...
mixin _$SelectedSpot {
  ...
  String get cpyrht => throw _privateConstructorUsedError;
...
class _$SelectedSpotCopyWithImpl<$Res, $Val extends SelectedSpot>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      cpyrht: null == cpyrht
          ? _value.cpyrht
          : cpyrht // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$SelectedSpotImpl implements _SelectedSpot {
  ...
  @override
  String toString() {
    return 'SelectedSpot(addr1: $addr1, addr2: $addr2, areacode: $areacode, booktour: $booktour, cat1: $cat1, cat2: $cat2, cat3: $cat3, contentid: $contentid, contenttypeid: $contenttypeid, cpyrht: $cpyrht, createdtime: $createdtime, dist: $dist, firstimage: $firstimage, firstimage2: $firstimage2, mapx: $mapx, mapy: $mapy, mlevel: $mlevel, modifiedtime: $modifiedtime, sigungucode: $sigungucode, tel: $tel, title: $title)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.cpyrht, cpyrht) || other.cpyrht == cpyrht) &&
...
abstract class _SelectedSpot implements SelectedSpot {
  factory _SelectedSpot(
      ...
      final String sigungucode,
      final String tel,
      final String title}) = _$SelectedSpotImpl;
