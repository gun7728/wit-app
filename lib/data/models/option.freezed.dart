...
/// @nodoc
mixin _$Option {
  int get currentOption => throw _privateConstructorUsedError;
...
class _$OptionImpl implements _Option {
  _$OptionImpl({this.currentOption = 0});
  ...
  @override
  String toString() {
    return 'Option(currentOption: $currentOption)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, currentOption);
...
abstract class _Option implements Option {
  factory _Option({final int currentOption}) = _$OptionImpl;

  factory _Option.fromJson(Map<String, dynamic> json) = _$OptionImpl.fromJson;

  @override
  int get currentOption;
